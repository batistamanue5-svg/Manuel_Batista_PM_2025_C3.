...
/*  ventas descandentes.
El programa, al recibir como datos tres valores que representan las ventas de los vendedores de una tienda discos, escribe las ventas en orden descendente.
    ...
    if (P > S)
        ...
        if (S > R)
            if (P > R)
                ...
                printf("\n\n El orden es S, R y P: %8.2f %8.2 %8.2f", S, R, P);
        else
