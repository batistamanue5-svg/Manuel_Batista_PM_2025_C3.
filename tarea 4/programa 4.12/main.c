...
{
int NU1, NU2, RES;
printf("\nIgresa los dos numeros enteros: ");
scanf("%d %d", &NU1, &NU2);
RES = mcd (NU1, NU2);
...
while ((N1 % I) || (N2 % I))
/* El ciclo se mantiene activo mientras (N1 % I) o (N2 % I) sean distintos de cero. Cuando el resultado de la evaluacion sean 0, el ciclo se detiene ya que se habra encontrado el maximo comun divisor. */
 I--;
return I;
}
